...
description: >
  A derivation-first walk through JPEG AI: learned analysis and synthesis
  transforms, the additive-uniform-noise relaxation of quantization, the scale
  hyperprior, Gaussian-mixture context models, gain-based rate control, and why
  the latents interest me for compressed-domain vision.
author: "Anupam Gupta"
date: "2026-05-04"
...
![Title slide. AI-generated.](jpeg-ai-slide.png){#fig-hero}
...
## Baby-steps to "the Ludicrous Idea": Machine Vision and Task-Aware Coding {#sec-ludicrous}
